...
CREATE RESOURCE MONITOR IF NOT EXISTS CLV_Analytics_MONITOR WITH
    CREDIT_QUOTA = 100
    FREQUENCY = MONTHLY
    START_TIMESTAMP = IMMEDIATELY
    NOTIFY_USERS = ('ADMIN_ROLE')
    TRIGGERS
        ON 75  PERCENT DO NOTIFY
        ON 90  PERCENT DO NOTIFY
        ON 100 PERCENT DO NOTIFY;

ALTER WAREHOUSE LOADING_WH   SET RESOURCE_MONITOR = CLV_Analytics_MONITOR;
ALTER WAREHOUSE TRANSFORM_WH SET RESOURCE_MONITOR = CLV_Analytics_MONITOR;