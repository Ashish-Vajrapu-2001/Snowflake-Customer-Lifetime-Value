...
transformed AS (
    SELECT
        ...
        PAYMENT_METHOD,
        PAYMENT_STATUS,
        CAST(SUBTOTAL_AMOUNT AS NUMBER(15,2)) AS SUBTOTAL_AMOUNT,
        CAST(DISCOUNT_AMOUNT AS NUMBER(15,2)) AS DISCOUNT_AMOUNT,
        CAST(TAX_AMOUNT AS NUMBER(15,2)) AS TAX_AMOUNT,
        CAST(SHIPPING_AMOUNT AS NUMBER(15,2)) AS SHIPPING_AMOUNT,
        CAST(TOTAL_AMOUNT AS NUMBER(15,2)) AS TOTAL_AMOUNT,
        CURRENCY_CODE,
        SHIPPING_ADDRESS_ID,
        BILLING_ADDRESS_ID,
        TRY_TO_DATE(PROMISED_DATE) AS PROMISED_DATE,
