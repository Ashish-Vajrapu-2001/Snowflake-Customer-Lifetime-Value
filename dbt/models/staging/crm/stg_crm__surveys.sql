...
transformed AS (
    SELECT
        ...
        CSAT_SCORE,
        CASE
            WHEN NPS_CATEGORY IS NOT NULL THEN NPS_CATEGORY
        ...
        FEEDBACK_TEXT,
        FEEDBACK_CATEGORY,
        TRY_TO_TIMESTAMP_NTZ(RESPONSE_DATE) AS RESPONSE_DATE,
        TRY_TO_TIMESTAMP_NTZ(SURVEY_SENT_DATE) AS SURVEY_SENT_DATE,
